package com.teste.CertsysBlog.configuration;
...
public class SweggerConfig {
	...
	.basePackage("com.teste.CertsysBlog.controller"))
	...
	.title("API - FEIRA DA CERTSYS")
	.description("Projeto API Spring - Feria da Certsys")
	.version("1.0.0")
	.license("Apache License Version 2.0")
	.licenseUrl("https://github.com/ThiagaoCode")
	.contact(contact())
	.build();
	}
